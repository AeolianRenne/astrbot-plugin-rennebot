...
_RESEARCH_MAX_ROUNDS_DEFAULT = 2
_RESEARCH_MAX_REQUESTS_DEFAULT = 12
...
class Main(Star):
    ...
    def __init__(self, context: Context) -> None:
        ...
        self.research_task = ResearchTaskService(
            ...
            _positive_int("AI_RESEARCH_MAX_ROUNDS", _RESEARCH_MAX_ROUNDS_DEFAULT),
            _positive_int("AI_RESEARCH_MAX_REQUESTS", _RESEARCH_MAX_REQUESTS_DEFAULT),
            _positive_int(
